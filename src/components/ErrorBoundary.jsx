    ...
    if (this.state?.hasError) {
      return (
        <div className="min-h-screen flex items-center justify-center bg-muted">
          <div className="text-center p-8 max-w-md bg-card border border-border rounded-xl shadow-card">
            ...
            <div className="flex justify-center items-center mt-6">
              <button
                className="px-4 py-2 bg-primary text-primary-foreground rounded shadow hover:bg-primary/90 transition flex items-center gap-2"
                onClick={() => {
